...
```bash
git clone https://github.com/Deshan-Chandima/portfolio.sh.git
cd portfolio.sh
```
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/Deshan-Chandima/portfolio.sh)
...
Found a bug? Please open an issue on [GitHub Issues](https://github.com/Deshan-Chandima/portfolio.sh/issues).
